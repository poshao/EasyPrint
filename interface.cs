...
//		object FromXml(System.Xml.XmlNode node);
	...
	/// 打印接口
	/// </summary>
	public interface IwPrint{
		void DoPrint(System.Collections.Generic.Dictionary<string,object> datalist,Helper.PrintHelper.wPrintEventArgs e);
		
		void DoPrintJson(Newtonsoft.Json.Linq.JToken json,Helper.PrintHelper.wPrintEventArgs e);
	}
}
